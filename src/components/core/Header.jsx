...
export const Header = ({ currentIndex }) => {
  ...
  return (
    <header className="flex items-start justify-between border-b border-silver w-[1252px] max-w-[1252px] mt-12 mx-auto">
      <Link to="/">
