    ...
    <footer className="flex justify-between border-t border-light-silver w-[1252px] max-w-[1252px] pt-8 pb-16 mx-auto">
      ...
      <section className="flex flex-col items-end">
        <form className="flex space-x-5" onSubmit={handleNewsletterFormSubmit}>
          <input required type="email" value={email} onChange={event => setEmail(event.target.value)} className="focus:ring-0 outline-none focus:rounded focus:border-2 focus:border-black border-0 border-b border-black placeholder-dark-silver text-sm w-[354px] px-1 py-3" placeholder="Give an email, get the newsletter" />
